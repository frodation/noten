...
bass = \relative g' {
    ...
    g8 [ a16 g fis e ] fis8. [ g16 a8 ] \clef "treble" | % 12
...
\score {
    \context PianoStaff <<
        ...
        \new Staff = "upper" \transpose bes c { \clef treble \key g \major \time 6/8 \soprano  }
        \new Staff = "lower" \transpose es c'  { \clef treble \key g \major \time 6/8 \bass }
    >>
    \layout{  }
    \midi { }
