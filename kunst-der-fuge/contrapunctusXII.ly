...
right = \relative c''{
	...
	cis d e! a,8 r16 \clef treble a8 r16
	d,4. r8.
...
left = \relative c'{
	...
	d16 b cis d e f e f d
	cis d e \clef treble a,8.~ a16 bes g
	f g e f a d c bes a
	bes d g cis, e a, bes a g
	...
	a e'16 f e d e d							%45
	c d c b c b a b a
	gis8-. r16 \clef treble a8-. r16 b8-. r16
	c8.~ c8 d16 c8 b16
	...
	e d c b c d e fis gis
	a e c d g! b, c f a, 
	\clef treble b e d c b a b a gis
...
\score{	\context PianoStaff <<
        \context Staff = "Upper" \transpose bes as {\global \clef treble \right}
        \context Staff = "Lower" \transpose es as' {\global \clef treble \left}
        >>
        \layout{}
}
